...
import json from 'src/assets/demo/data/applications.json';
...
export class DetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.step1 = this.fb.group({
      ...
      lenghtOfWork: new FormControl(''),
      employmentStatus: new FormControl('', Validators.required),
      startDate: new FormControl('', Validators.required),
      endDate: new FormControl(''),
      stillWork: new FormControl('', Validators.required),
  ...
  addApp(payload: any, sudah?: boolean) {
    this.appService.isiTemplate(payload);
  ...
  updateForm(product: any) {
    this.step1.reset({
      'salutation': { value: product.salutation, disabled: false },
      'fullName': { value: product.fullName, disabled: false },
      'aliasName': { value: product.aliasName, disabled: false },
      'identityNumber': { value: product.identityNumber, disabled: false},
      'birthPlace': { value: product.birthPlace, disabled: false},
      'birthDate': { value: product.birthDate, disabled: false},
      'motherName': { value: product.motherName, disabled: false},
      'phoneNumber': { value: product.phoneNumber, disabled: false},
      'email': { value: product.email, disabled: false},
      'gender': { value: product.gender, disabled: false},
      'religion': { value: product.religion, disabled: false },
      'maritialStatus': { value: product.maritialStatus, disabled: false },
      'occupation': { value: product.occupation, disabled: false},
      'companyName': { value: product.companyName, disabled: false },
      'lenghtOfWork': { value: product.lenghtOfWork, disabled: false},
      'employmentStatus': { value: product.employmentStatus, disabled: false },
      'startDate': { value: product.startDate, disabled: false},
      'endDate': { value: product.endDate, disabled: false },
      'stillWork': { value: product.stillWork, disabled: false },
    });
  }


  loadData() {
    this.appService.currentTemplate.subscribe(data => {
      this.apps = data;
      console.log(data);
